 ...
 *
 * This means that the structure of the two nodes has to be exactly the same. Two semantically equivalent elements may
 * not be structurally equivalent (e.g. `[ab]` is not structurally equal to `[ba]`).
 */
